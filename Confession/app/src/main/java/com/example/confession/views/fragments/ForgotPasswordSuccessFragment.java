 ...
 * Use the {@link ForgotPasswordSuccessFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ForgotPasswordSuccessFragment extends Fragment implements ForgotPasswordBinder.View {
    ...
    private Button fp_si_button;
    private TextView txt_resend_click;
     ...
     * @return A new instance of fragment ForgotPasswordSuccess.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_forgot_password_success, container, false);
    }
    ...
    private void InitView() {
        fp_si_button = getView().findViewById(R.id.fp_si_button);
        txt_resend_click= getView().findViewById(R.id.txt_resend_click);
        //forgot_pass_click= findViewById(R.id.forgot_pass_click);
    }

    private void InitListener() {

        fp_si_button.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        txt_resend_click.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Toast.makeText(getContext(), "Resend email", Toast.LENGTH_LONG).show();
